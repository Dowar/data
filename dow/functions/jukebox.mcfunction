...
execute as @a[scores={disk_use=1..,disk_id=1..}] at @s run scoreboard players operation @s disk_save = @s disk_id
execute as @a[scores={disk_use=1..,disk_save=1..}] at @s run stopsound @a[distance=..50] record
