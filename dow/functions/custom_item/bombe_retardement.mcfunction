...
execute as @e[type=item,scores={BombeTimer=1..20}] run data merge entity @s {CustomName:"{\"text\":\"Timer:3\",\"bold\":false}",CustomNameVisible:1,Health:1000,PickupDelay:999999}
execute as @e[type=item,scores={BombeTimer=21..40}] run data merge entity @s {CustomName:"{\"text\":\"Timer:2\",\"bold\":false}"}
execute as @e[type=item,scores={BombeTimer=41..60}] run data merge entity @s {CustomName:"{\"text\":\"Timer:1\",\"bold\":false}"}
